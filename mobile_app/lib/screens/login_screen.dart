...
class _LoginScreenState extends State<LoginScreen>
  ...
  // Giriş animasyonu için controller
  ...
  void _handleLogin() {
    ...
    final session = UserSession(
      email: _emailController.text.trim().isEmpty
          ? (_selectedRole == UserRole.marketing
                ? 'pazarlama@pulsebi.com'
                : 'yonetici@pulsebi.com')
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      // Arka plan rengi tam istediğin lüks krem tonuna ayarlandı
      backgroundColor: isDark ? null : const Color(0xFFFBF9F5),
      body: Center(
                        ...
                        children: [
                          ...
                          TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: _selectedRole == UserRole.marketing
                                  ? 'pazarlama@pulsebi.com'
                                  : 'yonetici@pulsebi.com',
